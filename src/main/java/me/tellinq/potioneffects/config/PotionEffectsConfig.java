...
public class PotionEffectsConfig extends Config {
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect speed = new PotionEffects.Effect("Speed", Potion.moveSpeed.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect slowness = new PotionEffects.Effect("Slowness", Potion.moveSlowdown.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect haste = new PotionEffects.Effect("Haste", Potion.digSpeed.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect miningFatigue = new PotionEffects.Effect("Mining Fatigue", Potion.digSlowdown.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect strength = new PotionEffects.Effect("Strength", Potion.damageBoost.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect jumpBoost = new PotionEffects.Effect("Jump Boost", Potion.jump.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect nausea = new PotionEffects.Effect("Nausea", Potion.confusion.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect regeneration = new PotionEffects.Effect("Regeneration", Potion.regeneration.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect resistance = new PotionEffects.Effect("Resistance", Potion.resistance.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect fireResistance = new PotionEffects.Effect("Fire Resistance", Potion.fireResistance.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect waterBreathing = new PotionEffects.Effect("Water Breathing", Potion.waterBreathing.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect invisibility = new PotionEffects.Effect("Invisibility", Potion.invisibility.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect blindness = new PotionEffects.Effect("Blindness", Potion.blindness.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect nightVision = new PotionEffects.Effect("Night Vision", Potion.nightVision.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect hunger = new PotionEffects.Effect("Hunger", Potion.hunger.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect weakness = new PotionEffects.Effect("Weakness", Potion.weakness.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect poison = new PotionEffects.Effect("Poison", Potion.poison.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect wither = new PotionEffects.Effect("Wither", Potion.wither.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect healthBoost = new PotionEffects.Effect("Health Boost", Potion.healthBoost.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect absorption = new PotionEffects.Effect("Absorption", Potion.absorption.id);
    ...
    @Page(
            ...
            location = PageLocation.TOP,
            category = "Effects")
    public static PotionEffects.Effect saturation = new PotionEffects.Effect("Saturation", Potion.saturation.id);
